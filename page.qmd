...
[1] data is taken from

Bubble Chart Representation: It’s an extension of the scatter plot used to look at relationships between three numeric variables. It displays a bubble chart with each bubble standing in for an industry and each bubble's size indicating the employment level. The axes show the output (Y-axis) and the percent change in hours (X-axis) [2].
...
2. Data Overlap: Several bubbles are grouped together in the center, making it difficult to discern between industries that have comparable data points [3].
...
In this data set, the data include employment levels, hours, output according to the industry. Where Output and hours data are in decimals but employment level data has large data. This makes data visualization over complicated. So we used
